 ...
 * |        |   Q  |   W  |   F  |   P  |   B  |                              |   J  |   L  |   U  |   Y  | ;  : |        |
 * |--------+------+------+------+------+------|                              |------+------+------+------+------+--------|
 * |        |   A  |   R  |   S  |   T  |   G  |                              |   M  |   N  |   E  |   I  |   O  |Ctrl/' "|
 * |--------+------+------+------+------+------+-------------.  ,-------------+------+------+------+------+------+--------|
 * |        |   Z  |   X  |   C  |   D  |   V  | [ {  |CapsLk|  |F-keys|  ] } |   K  |   H  | ,  < | . >  | /  ? |        |
 * `----------------------+------+------+------+------+------|  |------+------+------+------+------+----------------------'
 *                        |      | LGUI | LEAD | Space|  [{  |  |Sym/]}| Nav  | Mouse| RGUI |      |
 *                        `----------------------------------'  `----------------------------------'
 */
    [_COLEMAK_DH] = LAYOUT(
     _______ , KC_Q ,  KC_W   ,  KC_F  ,   KC_P ,   KC_B ,                                        KC_J,   KC_L ,  KC_U ,   KC_Y ,KC_SCLN, _______ ,
     _______ ,LGUI_A, LALT_R  , LCTL_S , LSHFT_T,   KC_G ,                                        KC_M, RSFT_N , RCTL_E,  RALT_I,RGUI_O , CTL_QUOT,
     _______ , KC_Z ,  KC_X   ,  KC_C  ,   KC_D ,   KC_V , KC_LBRC,KC_CAPS,     FKEYS  , KC_RBRC, KC_K,   KC_H ,KC_COMM, KC_DOT ,KC_SLSH, _______ ,
                                _______, KC_LGUI, KC_LEAD, KC_SPC ,KC_LBRC,    SYM_RBRC,   NAV   ,MOUSE,KC_RGUI,_______
    ),
/*
 ...
 * |        |  Tab |      |  {   |  }   |  `   |                              |  ↓   |  →   |  =   |  +   | BSPC |        |
 * |--------+------+------+------+------+------|                              |------+------+------+------+------+--------|
 * |        | Enter|  Alt |  [   |  ]   |  ~   |                              | PgUp | PgDn | Home | End  | Quote|        |
 * |--------+------+------+------+------+------+-------------.  ,-------------+------+------+------+------+------+--------|
 * |        |      |      |      |      |  |   |      |ScLck |  |      |      |  ↑   |  ←   |      |      |      |        |
 * `----------------------+------+------+------+------+------|  |------+------+------+------+------+----------------------'
 *                        |      |      |      |      |      |  |      |      |      |      |      |
 ...
 */
    [_NAV] = LAYOUT(
      _______, KC_TAB , _______, KC_LCBR, KC_RCBR, KC_GRV,                                      KC_DOWN, KC_RGHT, KC_EQL,  KC_PLUS, KC_BSPC, _______,
      _______, KC_ENT , KC_LALT, KC_LBRC, KC_RBRC, KC_TILD,                                     KC_PGUP, KC_PGDN, KC_HOME, KC_END , KC_QUOT, _______,
      _______, _______, _______, _______, _______, KC_PIPE, _______, KC_SLCK, _______, _______, KC_UP  , KC_LEFT, _______, _______, _______, _______,
 ...
 */
    [_SYM] = LAYOUT(
      ...
      _______, KC_BSLS, KC_COLN, KC_SCLN, KC_MINS, KC_LBRC, KC_LCBR, _______, _______, KC_RCBR, KC_RBRC, KC_UNDS, KC_COMM,  KC_DOT, KC_SLSH, _______,
                                 _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
    ),
